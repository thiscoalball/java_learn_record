        ...
        switch (this.getDirect()) {
            case 0:
                for (int i = 0; i < bricks.size(); i++) {
                    ...
                    if (this.getX() + 40 >= brick.getX()
                        ...
                        return true;
                    if (this.getX() + 30 >= brick.getX()
                            && this.getX() + 30 <= brick.getX() + 15
                            && this.getY() >= brick.getY()
                            && this.getY() <= brick.getY() + 15
                    )
                        return true;
                    if (this.getX() + 20 >= brick.getX()
                            && this.getX() + 20 <= brick.getX() + 15
                            && this.getY() >= brick.getY()
                            && this.getY() <= brick.getY() + 15
                    )
                        return true;
                    if (this.getX() + 10 >= brick.getX()
                            && this.getX() + 10 <= brick.getX() + 15
                            && this.getY() >= brick.getY()
                            && this.getY() <= brick.getY() + 15
                    )
                        return true;
            ...
            case 1:
                for (int i = 0; i < bricks.size(); i++) {
                    ...
                    if (this.getX() + 60 >= brick.getX()
                            && this.getX() + 60 <= brick.getX() + 15
                            && this.getY() + 30 >= brick.getY()
                            && this.getY() + 30 <= brick.getY() + 15
                    )
                        return true;
                    if (this.getX() + 60 >= brick.getX()
                            && this.getX() + 60 <= brick.getX() + 15
                            && this.getY() + 10 >= brick.getY()
                            && this.getY() + 10 <= brick.getY() + 15
                    )
                        return true;
                }
                break;
